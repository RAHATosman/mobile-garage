                ...
                <div className="login__inner">
                    ...
                    <div className="login__bottom">
                        ...
                        <div className="login__social--box">
                            ...
                            <button className="login__social btn" onClick={()=>handleSocialSignIn(googleSignIn)}><img src={GoogleIcon} alt="Google" /><span>Continue with Google</span></button>
                            <button className="login__social btn" onClick={()=>handleSocialSignIn(githubSignIn)}><img src={GithubIcon} alt="Google" /><span>Continue with Github</span></button>
